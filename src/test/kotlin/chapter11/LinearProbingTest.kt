...
class LinearProbingTest {
    ...
    @Nested
    @DisplayName("Given a linear probing with size=5 and a hash function that always returns the given key")
    inner class Init {

        private val h = linearProbing(m = 5, h = { it })
        ...
        inner class SmallKeys {
            ...
            fun `probing with i greater than m`() {
                assertThat(h(0, 6)).isEqualTo(1)
                assertThat(h(1, 9)).isEqualTo(0)
                assertThat(h(2, 13)).isEqualTo(0)
                assertThat(h(3, 23)).isEqualTo(1)
                assertThat(h(4, 31)).isEqualTo(0)
            }
        ...
        inner class LargeKeys {
            ...
            @Test
            fun `probing with i greater than m`() {
                assertThat(h(11, 6)).isEqualTo(2)
                assertThat(h(17, 9)).isEqualTo(1)
                assertThat(h(37, 13)).isEqualTo(0)
                assertThat(h(54, 23)).isEqualTo(2)
                assertThat(h(71, 31)).isEqualTo(2)
            }
